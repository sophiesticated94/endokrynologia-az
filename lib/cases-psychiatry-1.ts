    ...
    [
      ...
      },
      {
        ...
        choices: [
          ...
          ['Stan ten jest klasycznym objawem zaostrzenia schizofrenii i wymaga jedynie podwojenia dawki neuroleptyku', 'Schizofrenia przebiega typowo przy jasnej świadomości; zaburzenia przytomności silnie przemawiają za procesem wtórnym i wymagają pilnego różnicowania (delirium, encefalopatia, zatrucie).'],
  ...
  makeFlexibleCase(
    ...
    [
      ...
      },
      {
        ...
        choices: [
          ['Zmniejszają prawdopodobieństwo jawnej niedoczynności tarczycy i aktywnego stanu zapalnego, lecz same w sobie nie stanowią dowodu na etiologię pierwotną', 'Prawidłowe wyniki badań zmniejszają prawdopodobieństwo typowych masek somatycznych, ale nie potwierdzają automatycznie diagnozy psychiatrycznej (błąd: negatywny wynik somatyczny ≠ dowód na proces pierwotny; rozpoznanie wymaga kryteriów fenotypowych).'],
          ['Definitywnie wykluczają wszystkie schorzenia somatyczne mogące imitować zespół zmęczeniowy', 'Prawidłowe TSH, CRP i morfologia nie wykluczają innych przyczyn (np. obturacyjnego bezdechu sennego, wczesnych faz chorób autoimmunologicznych czy neurologicznych).'],
          ['Stanowią bezpośredni dowód całkowitej remisji biologicznej wykluczający wskazania do farmakoterapii', 'Prawidłowe parametry tarczycy i markerów zapalnych zmniejszają podejrzenie wybranych schorzeń somatycznych, lecz nie oceniają nasilenia osiowych objawów afektywnych.'],
        ],
        answerIndex: 0,
      },
      {
        ...
        prompt: 'Jakie opcje postępowania pierwszego wyboru rekomendują wytyczne NICE (NG222) i CANMAT w nowym epizodzie o umiarkowanym nasileniu, z uwzględnieniem shared decision-making?',
        choices: [
          ['Przedstawienie pacjentowi równorzędnych opcji pierwszego wyboru: CBT, farmakoterapii SSRI lub terapii skojarzonej (SSRI + CBT), z wyborem opartym na wspólnej decyzji', 'NICE NG222 podkreśla shared decision-making: w nowym epizodzie depresji umiarkowanej/ciężkiej dopuszcza samą psychoterapię (CBT), sam antydepresant (np. SSRI) lub terapię skojarzoną w zależności od preferencji chorego, historii i tolerancji.'],
          ['Monoterapia lekami nasennymi z grupy Z przez 6 miesięcy', 'Leki z grupy Z nie leczą depresji i niosą ryzyko uzależnienia oraz tolerancji.'],
