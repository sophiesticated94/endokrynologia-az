...
sections:[{title:'Przełom tarczycowy',text:'To zagrażająca życiu dekompensacja tyreotoksykozy. Gorączka, znaczna tachykardia, zaburzenia świadomości, niewydolność serca i objawy przewodu pokarmowego powinny uruchomić pilne postępowanie. Częstym czynnikiem wyzwalającym jest zakażenie lub przerwanie leczenia. Rozpoznanie opiera się na obrazie klinicznym; sam poziom FT4 nie mierzy ciężkości przełomu.'},{title:'Ciężka niedoczynność',text:'Hipotermia, bradykardia, hipowentylacja i zaburzenia świadomości u osoby z niedoczynnością sugerują jej ciężką dekompensację, określaną jako śpiączka hipometaboliczna. Pełna śpiączka nie musi być obecna. Stan wymaga pilnej hospitalizacji i monitorowania narządowego.'},{title:'Priorytety zespołu',text:'Najpierw ocena ABC, wezwanie pomocy i leczenie w warunkach intensywnego nadzoru. Równolegle pobiera się badania i poszukuje czynnika wyzwalającego. Leczenie hormonalne oraz wspomagające dobiera zespół specjalistyczny. W przełomie stosuje się wielokierunkowe hamowanie nadmiaru hormonów; w ciężkiej niedoczynności uzupełnia niedobór, uwzględniając możliwą niewydolność nadnerczy.'}],
table:{headers:['Obraz','Pilna hipoteza'],rows:[['Gorączka + tachykardia + zaburzenia świadomości','Przełom w kontekście tyreotoksykozy'],['Hipotermia + bradykardia + hipowentylacja','Ciężka dekompensacja niedoczynności'],['Zakażenie / przerwanie leczenia','Możliwy czynnik wyzwalający'],['Niestabilność narządowa','Natychmiastowa pomoc, nie kontrola ambulatoryjna']]},
advanced:'W przełomie z upośledzoną funkcją serca beta-blokada wymaga szczególnej ostrożności hemodynamicznej. Gdy stosuje się jod w nadprodukcji, kolejność względem tyreostatyku ma znaczenie. W ciężkiej niedoczynności należy zabezpieczyć możliwą niewydolność nadnerczy przed lub wraz z substytucją. Ten moduł uczy rozpoznania i priorytetów; szczegółowe dawkowanie wymaga aktualnego protokołu oddziałowego.',summary:'Ciężkość określa stan narządów, nie sama liczba hormonów. Rozpoznaj alarm i uruchom pilną pomoc.',sourceIds:['storm','coma','emergency','central'],questions:[
